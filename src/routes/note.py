    ...
    try:
        ...
        if 'event_date' in data and data['event_date']:
            try:
                ...
                # Silently ignore invalid date format; field remains None
                pass
        if 'event_time' in data and data['event_time']:
            try:
                ...
                # Silently ignore invalid time format; field remains None
                pass
        ...
        if 'event_date' in data:
            if data['event_date']:
                try:
                    ...
                    # Silently ignore invalid date format; field remains unchanged
                    pass
            else:
        ...
        if 'event_time' in data:
            if data['event_time']:
                try:
                    ...
                    # Silently ignore invalid time format; field remains unchanged
                    pass
            else:
